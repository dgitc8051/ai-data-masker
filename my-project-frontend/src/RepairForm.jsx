            ...
            {step === 1 && (
                <div style={{
                    ...
                    <div style={{ display: 'grid', gap: '14px' }}>
                        {[
                            { num: '1', icon: '📝', title: '填寫需求', desc: '填寫線上表單，描述問題狀況、上傳現場照片與偏好維修時間' },
                            { num: '2', icon: '📱', title: '師傅接案', desc: '師傅查看照片後提供預估費用與維修時間，LINE 通知您確認' },
                            { num: '3', icon: '✅', title: '確認預約', desc: '確認費用與時間後師傅即安排前往，不滿意可取消（需付車馬費）' },
                            { num: '4', icon: '🔧', title: '到府維修', desc: '師傅準時到府服務，完工後線上回報實際費用並結案' },
                        ].map(s => (
                            <div key={s.num} style={{
